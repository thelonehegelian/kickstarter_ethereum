...
contract Campaign {
    ...
    */
    ...
    // parameters: key from the // SPDX-License-Identifier: MIT
pragma solidity >=0.7.0 <0.9.0;
...
contract Campaign {
    ...
    */
    ...
    struct Request {
        ...
        address payable recipient; // the person who should receive the money at the finalization of the request 
